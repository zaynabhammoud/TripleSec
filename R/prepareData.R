#' This function transforms the given data into a data frame containing only
#' the columns necessary for the TripleSec algorithm, therefor for the risk assessment.
#'
...
prepareData <- function(data, firstFeature, featureList){
  ...
  inputData <-
    data.frame(
      #creating inputData All, table containing all information and given column names
      ID = data$RID,
